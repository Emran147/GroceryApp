...
import com.emran.groceryapp.adapters.AdapterOrderedItem;
import com.emran.groceryapp.models.ModelOrderedItem;
...
public class OrderDetailsSellerActivity extends AppCompatActivity {
    ...
    //araylist to hold ordered items
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //handle click, show edit order status dialog
    ...
    private void editOrderStatus(final String selectedOption) {
        /*Edit the order status according to the selection*/
    ...
    private void openMap() {
        /*open google map with direction from user location to shop location*/
